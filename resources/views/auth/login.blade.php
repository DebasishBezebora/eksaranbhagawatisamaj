...
<head>
    ...
    <script nonce="b6d88d68-c5dc-44bd-9b08-10d1b854a9b3">
        (function(w, d) {
            ! function(a, e, t, r) {
    ...
    <style>
        body {
            background: url('images/exam_wall.jpg') no-repeat;
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="#"><img src="https://adtu.in/coen/assets/images/adtu-logo.png" height="100px"></a>
        </div>
