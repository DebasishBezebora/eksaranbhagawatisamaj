...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'F4cC2Q62sVM3qbd7', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/eksbs.css", // Project stylesheet file name
    ...
    "AUDIT_TRAIL_TABLE_NAME" => "user_log", // Audit trail table name
    "AUDIT_TRAIL_TABLE_VAR" => "user_log", // Audit trail table var
    ...
    "ADMIN_USER_NAME" => "system", // Administrator user name
    "ADMIN_PASSWORD" => "syst3m!23", // Administrator password
    ...
    "USER_LEVEL_PRIV_TABLE" => "`user_permission`",
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,png,pdf", // Allowed file extensions
