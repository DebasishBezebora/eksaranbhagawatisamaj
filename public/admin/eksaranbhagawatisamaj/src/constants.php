...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.4.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "eksbs"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{514776AE-DABD-4646-A974-0B7DBFD74303}"); // Project ID
