 ...
 * Page class
 */
class UserPermissionView extends UserPermission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserPermissionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("userlevelid") ?? Route("userlevelid")) !== null) {
                ...
                $returnUrl = "UserPermissionList"; // Return to list
            }
            if (($keyValue = Get("_tablename") ?? Route("_tablename")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "UserPermissionList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "UserPermissionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("UserPermissionList"), "", $this->TableVar, true);
        $pageId = "view";
