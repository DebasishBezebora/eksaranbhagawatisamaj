 ...
 * Page class
 */
class SiteSettingsDelete extends SiteSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SiteSettingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SiteSettingsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SiteSettingsList"); // Return to list
                return;
            }
        }
