...
/**
 * Table class for photo_gallery
 */
class PhotoGallery extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'photo_gallery';
        $this->TableName = 'photo_gallery';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`photo_gallery`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Active->Lookup = new Lookup('Active', 'photo_gallery', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`photo_gallery`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PhotoGalleryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PhotoGalleryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PhotoGalleryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PhotoGalleryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "PhotoGalleryAdd";
            case Config("API_EDIT_ACTION"):
                return "PhotoGalleryEdit";
            case Config("API_DELETE_ACTION"):
                return "PhotoGalleryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PhotoGalleryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PhotoGalleryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PhotoGalleryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PhotoGalleryAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PhotoGalleryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PhotoGalleryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PhotoGalleryDelete", $this->getUrlParm());
    }
