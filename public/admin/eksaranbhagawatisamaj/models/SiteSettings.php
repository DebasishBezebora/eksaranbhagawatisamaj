...
/**
 * Table class for site_settings
 */
class SiteSettings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'site_settings';
        $this->TableName = 'site_settings';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`site_settings`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Contact_No_1->InputTextType = "text";
        $this->Contact_No_1->Nullable = false; // NOT NULL field
        $this->Contact_No_1->Required = true; // Required field
        $this->Fields['Contact_No_1'] = &$this->Contact_No_1;

        // Contact_No_2
        $this->Contact_No_2 = new DbField(
            'site_settings',
            'site_settings',
            'x_Contact_No_2',
            'Contact_No_2',
        ...
        $this->Contact_No_2->InputTextType = "text";
        $this->Fields['Contact_No_2'] = &$this->Contact_No_2;
        ...
        $this->Logo->UploadAllowedFileExt = "gif,jpeg,jpg,png";
        $this->Logo->UploadPath = "files/";
        $this->Fields['Logo'] = &$this->Logo;

        // Favicon
        $this->Favicon = new DbField(
            'site_settings',
            'site_settings',
            'x_Favicon',
            'Favicon',
        ...
        $this->Favicon->InputTextType = "text";
        $this->Favicon->Nullable = false; // NOT NULL field
        $this->Favicon->Required = true; // Required field
        $this->Favicon->UploadAllowedFileExt = "gif,jpeg,jpg,png";
        $this->Favicon->UploadPath = "files/";
        $this->Fields['Favicon'] = &$this->Favicon;
        ...
        $this->Twitter->InputTextType = "text";
        ...
        $this->Active->Lookup = new Lookup('Active', 'site_settings', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`site_settings`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Contact_No_1->DbValue = $row['Contact_No_1'];
        $this->Contact_No_2->DbValue = $row['Contact_No_2'];
    ...
    public function deleteUploadedFiles($row)
    {
        ...
        $oldFiles = EmptyValue($row['Favicon']) ? [] : [$row['Favicon']];
        foreach ($oldFiles as $oldFile) {
            if (file_exists($this->Favicon->oldPhysicalUploadPath() . $oldFile)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SiteSettingsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "SiteSettingsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SiteSettingsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "SiteSettingsAdd";
            case Config("API_EDIT_ACTION"):
                return "SiteSettingsEdit";
            case Config("API_DELETE_ACTION"):
                return "SiteSettingsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SiteSettingsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SiteSettingsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SiteSettingsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SiteSettingsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("SiteSettingsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SiteSettingsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("SiteSettingsDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->Contact_No_1->EditValue = $this->Contact_No_1->CurrentValue;
        ...
        $this->Contact_No_2->EditValue = $this->Contact_No_2->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Contact_No_1);
                    $doc->exportCaption($this->Contact_No_2);
                    $doc->exportCaption($this->Brand_Name);
                    $doc->exportCaption($this->Logo);
                    $doc->exportCaption($this->Favicon);
                    $doc->exportCaption($this->Address);
                    $doc->exportCaption($this->Facebook);
                    $doc->exportCaption($this->Twitter);
                    $doc->exportCaption($this->Instagram);
                    $doc->exportCaption($this->Map);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Contact_No_1);
                        $doc->exportField($this->Contact_No_2);
                        $doc->exportField($this->Brand_Name);
                        $doc->exportField($this->Logo);
                        $doc->exportField($this->Favicon);
                        $doc->exportField($this->Address);
                        $doc->exportField($this->Facebook);
                        $doc->exportField($this->Twitter);
                        $doc->exportField($this->Instagram);
                        $doc->exportField($this->Map);
