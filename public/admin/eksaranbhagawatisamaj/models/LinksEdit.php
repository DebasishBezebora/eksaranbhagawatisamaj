...
class LinksEdit extends Links
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // Link_Content
            $this->Link_Content->setDbValueDef($rsnew, $this->Link_Content->CurrentValue, "", $this->Link_Content->ReadOnly);
