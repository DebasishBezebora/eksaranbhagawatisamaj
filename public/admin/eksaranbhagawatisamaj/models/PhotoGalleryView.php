 ...
 * Page class
 */
class PhotoGalleryView extends PhotoGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PhotoGalleryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "PhotoGalleryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PhotoGalleryList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PhotoGalleryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
