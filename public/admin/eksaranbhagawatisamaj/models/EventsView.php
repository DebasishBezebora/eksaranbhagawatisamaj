    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "EventsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EventsList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EventsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
