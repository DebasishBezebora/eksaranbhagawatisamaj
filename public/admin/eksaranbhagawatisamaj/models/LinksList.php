...
class LinksList extends Links
{
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "LinksAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "LinksDelete";
        $this->MultiUpdateUrl = "LinksUpdate";
    ...
    public function run()
    {
        ...
        $this->Link_Content->Visible = false;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_Link_Name") && $CurrentForm->hasValue("o_Link_Name") && $this->Link_Name->CurrentValue != $this->Link_Name->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_URL_Slug") && $CurrentForm->hasValue("o_URL_Slug") && $this->URL_Slug->CurrentValue != $this->URL_Slug->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->Link_Name->clearErrorMessage();
        $this->URL_Slug->clearErrorMessage();
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flinkssrch");
        }
        $filterList = Concat($filterList, $this->ID->AdvancedSearch->toJson(), ","); // Field ID
        $filterList = Concat($filterList, $this->Link_Name->AdvancedSearch->toJson(), ","); // Field Link_Name
        $filterList = Concat($filterList, $this->URL_Slug->AdvancedSearch->toJson(), ","); // Field URL_Slug
        $filterList = Concat($filterList, $this->Link_Content->AdvancedSearch->toJson(), ","); // Field Link_Content
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "flinkssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Link_Name
        $this->Link_Name->AdvancedSearch->SearchValue = @$filter["x_Link_Name"];
        $this->Link_Name->AdvancedSearch->SearchOperator = @$filter["z_Link_Name"];
        $this->Link_Name->AdvancedSearch->SearchCondition = @$filter["v_Link_Name"];
        $this->Link_Name->AdvancedSearch->SearchValue2 = @$filter["y_Link_Name"];
        $this->Link_Name->AdvancedSearch->SearchOperator2 = @$filter["w_Link_Name"];
        $this->Link_Name->AdvancedSearch->save();
        ...
        // Field Link_Content
        $this->Link_Content->AdvancedSearch->SearchValue = @$filter["x_Link_Content"];
        $this->Link_Content->AdvancedSearch->SearchOperator = @$filter["z_Link_Content"];
        $this->Link_Content->AdvancedSearch->SearchCondition = @$filter["v_Link_Content"];
        $this->Link_Content->AdvancedSearch->SearchValue2 = @$filter["y_Link_Content"];
        $this->Link_Content->AdvancedSearch->SearchOperator2 = @$filter["w_Link_Content"];
        $this->Link_Content->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->Link_Name, $default, false); // Link_Name
        $this->buildSearchSql($where, $this->URL_Slug, $default, false); // URL_Slug
        $this->buildSearchSql($where, $this->Link_Content, $default, false); // Link_Content
        $this->buildSearchSql($where, $this->Photos, $default, false); // Photos
        $this->buildSearchSql($where, $this->Video_1, $default, false); // Video_1
        $this->buildSearchSql($where, $this->Video_2, $default, false); // Video_2
        $this->buildSearchSql($where, $this->Video_3, $default, false); // Video_3
        ...
        $this->buildSearchSql($where, $this->IP, $default, false); // IP
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->Link_Name->AdvancedSearch->save(); // Link_Name
            $this->URL_Slug->AdvancedSearch->save(); // URL_Slug
            $this->Link_Content->AdvancedSearch->save(); // Link_Content
            $this->Photos->AdvancedSearch->save(); // Photos
            $this->Video_1->AdvancedSearch->save(); // Video_1
            $this->Video_2->AdvancedSearch->save(); // Video_2
            $this->Video_3->AdvancedSearch->save(); // Video_3
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->Link_Name;
        $searchFlds[] = &$this->URL_Slug;
        $searchFlds[] = &$this->Link_Content;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->Link_Name->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->URL_Slug->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Link_Content->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Photos->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Video_1->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Video_2->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Video_3->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->Link_Name->AdvancedSearch->unsetSession();
        $this->URL_Slug->AdvancedSearch->unsetSession();
        $this->Link_Content->AdvancedSearch->unsetSession();
        $this->Photos->AdvancedSearch->unsetSession();
        $this->Video_1->AdvancedSearch->unsetSession();
        $this->Video_2->AdvancedSearch->unsetSession();
        $this->Video_3->AdvancedSearch->unsetSession();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Link_Name); // Link_Name
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->setSessionOrderBy($orderBy);
                $this->ID->setSort("");
                $this->Link_Name->setSort("");
                $this->URL_Slug->setSort("");
                $this->Link_Content->setSort("");
                $this->Photos->setSort("");
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flinkslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flinkslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Link_Name", $this->createColumnOption("Link_Name"));
            $option->add("URL_Slug", $this->createColumnOption("URL_Slug"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"flinkssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"flinkssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
            ...
            foreach ($this->ListActions->Items as $listaction) {
                if ($listaction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="flinkslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
            ...
            if ($this->isGridAdd()) {
                ...
                $item->Body = "<button class=\"ew-action ew-grid-insert\" title=\"" . HtmlTitle($Language->phrase("GridInsertLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("GridInsertLink")) . "\" form=\"flinkslist\" formaction=\"" . GetUrl($this->pageName()) . "\">" . $Language->phrase("GridInsertLink") . "</button>";
                // Add grid cancel
            ...
            if ($this->isGridEdit()) {
                ...
                $option->UseDropDownButton = false;
                    ...
                    $item->Body = "<button class=\"ew-action ew-grid-save\" title=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" form=\"flinkslist\" formaction=\"" . GetUrl($this->pageName()) . "\">" . $Language->phrase("GridSaveLink") . "</button>";
                    $item = &$option->add("gridcancel");
                    $cancelurl = $this->addMasterUrl($pageUrl . "action=cancel");
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->Link_Name->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Link_Name->AdvancedSearch->SearchValue != "" || $this->Link_Name->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->URL_Slug->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->URL_Slug->AdvancedSearch->SearchValue != "" || $this->URL_Slug->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Link_Content->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Link_Content->AdvancedSearch->SearchValue != "" || $this->Link_Content->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Photos->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Photos->AdvancedSearch->SearchValue != "" || $this->Photos->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Video_1->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Video_1->AdvancedSearch->SearchValue != "" || $this->Video_1->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Video_2->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Video_2->AdvancedSearch->SearchValue != "" || $this->Video_2->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Video_3->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Video_3->AdvancedSearch->SearchValue != "" || $this->Video_3->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->IP->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->IP->AdvancedSearch->SearchValue != "" || $this->IP->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_Link_Name")) {
            $this->Link_Name->setOldValue($CurrentForm->getValue("o_Link_Name"));
        }
        ...
        if ($CurrentForm->hasValue("o_URL_Slug")) {
            $this->URL_Slug->setOldValue($CurrentForm->getValue("o_URL_Slug"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->isExport()) {
                $this->Link_Name->ViewValue = $this->highlightValue($this->Link_Name);
            }
            ...
            if (!$this->isExport()) {
                $this->URL_Slug->ViewValue = $this->highlightValue($this->URL_Slug);
            }
            ...
            if (!$this->isExport()) {
                $this->Video_1->ViewValue = $this->highlightValue($this->Video_1);
            }
            ...
            if (!$this->isExport()) {
                $this->Video_2->ViewValue = $this->highlightValue($this->Video_2);
            }
            ...
            if (!$this->isExport()) {
                $this->Video_3->ViewValue = $this->highlightValue($this->Video_3);
            }
            ...
            if (!$this->isExport()) {
                $this->Created_BY->ViewValue = $this->highlightValue($this->Created_BY);
            }
            ...
            if (!$this->isExport()) {
                $this->IP->ViewValue = $this->highlightValue($this->IP);
            }
    ...
    protected function editRow()
    {
        ...
        if ($this->URL_Slug->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`URL_Slug` = '" . AdjustSql($this->URL_Slug->CurrentValue, $this->Dbid) . "')";
        ...
        if (!$rsold) {
            ...
            // Link_Name
            $this->Link_Name->setDbValueDef($rsnew, $this->Link_Name->CurrentValue, "", $this->Link_Name->ReadOnly);

            // URL_Slug
            $this->URL_Slug->setDbValueDef($rsnew, $this->URL_Slug->CurrentValue, "", $this->URL_Slug->ReadOnly);
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['Link_Name']); // Link_Name
        $hash .= GetFieldHash($row['URL_Slug']); // URL_Slug
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="flinkslist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flinkssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"LinksSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"links\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" data-ew-action=\"modal\" data-url=\"LinksSearch\" data-btn=\"SearchBtn\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;

        // Search highlight button
        $item = &$this->SearchOptions->add("searchhighlight");
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"flinkssrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
