 ...
 * Page class
 */
class LinksDelete extends Links
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LinksDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LinksList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LinksList"); // Return to list
                return;
            }
        }
