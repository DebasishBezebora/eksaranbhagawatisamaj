 ...
 * Page class
 */
class PhotoGalleriesDelete extends PhotoGalleries
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PhotoGalleriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PhotoGalleriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PhotoGalleriesList"); // Return to list
                return;
            }
        }
