 ...
 * Page class
 */
class PhotoGalleriesView extends PhotoGalleries
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PhotoGalleriesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "PhotoGalleriesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PhotoGalleriesList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PhotoGalleriesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
