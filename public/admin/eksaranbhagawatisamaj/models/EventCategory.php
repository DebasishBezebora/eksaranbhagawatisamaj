...
/**
 * Table class for event_category
 */
class EventCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'event_category';
        $this->TableName = 'event_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`event_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Active->Lookup = new Lookup('Active', 'event_category', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`event_category`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EventCategoryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EventCategoryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EventCategoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EventCategoryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EventCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "EventCategoryEdit";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EventCategoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EventCategoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EventCategoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EventCategoryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EventCategoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EventCategoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EventCategoryDelete", $this->getUrlParm());
    }
