 ...
 * Page class
 */
class UserLogDelete extends UserLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLogDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserLogList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserLogList"); // Return to list
                return;
            }
        }
