    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "LinksList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "LinksList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "LinksList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
