 ...
 * Page class
 */
class PhotoGalleryDelete extends PhotoGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PhotoGalleryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PhotoGalleryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PhotoGalleryList"); // Return to list
                return;
            }
        }
