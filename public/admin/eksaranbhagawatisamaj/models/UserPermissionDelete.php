 ...
 * Page class
 */
class UserPermissionDelete extends UserPermission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserPermissionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserPermissionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserPermissionList"); // Return to list
                return;
            }
        }
