 ...
 * Page class
 */
class SiteSettingsView extends SiteSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SiteSettingsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "SiteSettingsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "SiteSettingsList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "SiteSettingsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
