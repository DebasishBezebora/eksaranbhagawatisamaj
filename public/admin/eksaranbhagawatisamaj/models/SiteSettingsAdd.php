 ...
 * Page class
 */
class SiteSettingsAdd extends SiteSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SiteSettingsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SiteSettingsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->Favicon->CurrentValue = null; // Clear file related field
