 ...
 * Page class
 */
class UserLogView extends UserLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLogView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "UserLogList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "UserLogList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "UserLogList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("UserLogList"), "", $this->TableVar, true);
        $pageId = "view";
