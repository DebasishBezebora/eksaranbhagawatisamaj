...
class UserLog extends DbTable
{
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`user_log`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserLogList");
    }
    ...
    {
        global $Language;
        if ($pageName == "UserLogView") {
            return $Language->phrase("View");
        } elseif ($pageName == "UserLogEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UserLogAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserLogView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UserLogView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UserLogAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UserLogAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UserLogEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserLogAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UserLogDelete", $this->getUrlParm());
    }
