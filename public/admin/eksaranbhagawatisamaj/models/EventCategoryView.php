 ...
 * Page class
 */
class EventCategoryView extends EventCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventCategoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "EventCategoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EventCategoryList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EventCategoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EventCategoryList"), "", $this->TableVar, true);
        $pageId = "view";
