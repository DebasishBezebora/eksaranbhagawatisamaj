 ...
 * Page class
 */
class EventsDelete extends Events
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EventsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EventsList"); // Return to list
                return;
            }
        }
