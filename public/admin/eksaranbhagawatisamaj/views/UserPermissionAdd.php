...
// Page object
$UserPermissionAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { user_permission: currentTable } });
var currentForm, currentPageID;
var fuser_permissionadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fuser_permissionadd = new ew.Form("fuser_permissionadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fuser_permissionadd;

    // Add fields
    var fields = currentTable.fields;
    fuser_permissionadd.addFields([
    ...
    // Form_CustomValidate
    fuser_permissionadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fuser_permissionadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fuser_permissionadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fuser_permissionadd" id="fuser_permissionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
