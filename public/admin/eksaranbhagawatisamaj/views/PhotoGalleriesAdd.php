...
// Page object
$PhotoGalleriesAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { photo_galleries: currentTable } });
var currentForm, currentPageID;
var fphoto_galleriesadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fphoto_galleriesadd = new ew.Form("fphoto_galleriesadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fphoto_galleriesadd;

    // Add fields
    var fields = currentTable.fields;
    fphoto_galleriesadd.addFields([
    ...
    // Form_CustomValidate
    fphoto_galleriesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fphoto_galleriesadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fphoto_galleriesadd.lists.Active = <?= $Page->Active->toClientList($Page) ?>;
    loadjs.done("fphoto_galleriesadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fphoto_galleriesadd" id="fphoto_galleriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
